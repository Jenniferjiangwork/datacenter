...
namespace Report.Infra.Data.Context
{
    ...
    {
        private readonly DatacentreDBContext _context;
        private readonly IConfiguration _configuration;
        public AuthRepository(DatacentreDBContext context, IConfiguration configuration)
        {
        ...
        public async Task<ServiceResponse<int>> Register(User user, string password)
        {
            ...
            user.PasswordBcrypt = BCryptNet.HashPassword(password);
